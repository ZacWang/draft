...
一些计算：
- prefill： 4 node 32 卡，32 个冗余路由专家，每张卡 9 个路由专家 + 1 个共享专家
    - 模型每层包含：256 路由专家 + 1 共享专家
        - 256/32=8 路由专家
        - 每个卡 hold 8 个路由专家，再冗余出来一个路由专家
        - 每个卡都 hold 共享专家
- decode: 18 node 144 卡，32 个冗余路由专家，每张卡 2 个路由专家和 1 个共享专家
    - 模型每层包含：256 路由专家 + 1 共享专家
        - 256/144 ~= 2 路由专家
        - 每个卡 hold 2 个路由专家，全局冗余 32 个路由专家
        - 每个卡都 hold 1 个共享专家
